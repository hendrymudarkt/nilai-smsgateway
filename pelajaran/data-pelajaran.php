...
?>
  <div class="container">
  <div class="row">
  <legend>Data Pelajaran</legend>
  <p><a href="../pelajaran/tambah-data-pelajaran.php"><button type="button" class="btn btn-primary">Tambah Data</button></a></p>
    ...
    ?>
      <tr>
        <td><?php echo $No; ?></td>
        <td><?php echo $data['kodepelajaran']; ?></td>
        <td><?php echo $data['namapelajaran']; ?></td>
        <td align="center">
        <a href="ubah-data-pelajaran.php?kodepelajaran=<?php echo $data['kodepelajaran'];?>">
        <span class="glyphicon glyphicon-edit" aria-hidden="true" title="Ubah"></span>
        </a> ||
        <a href="hapus-data-pelajaran.php?kodepelajaran=<?php echo $data['kodepelajaran'];?>">
